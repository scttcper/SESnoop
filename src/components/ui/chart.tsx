...
type TooltipPayload = RechartsPrimitive.TooltipPayloadEntry<TooltipValue, TooltipName>;
...
function ChartTooltipContent({
  ...
  Partial<Omit<RechartsPrimitive.TooltipContentProps<TooltipValue, TooltipName>, 'payload'>> & {
